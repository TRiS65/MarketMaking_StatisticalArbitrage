#!/usr/bin/env python3
"""Run the current-data research pipeline in dependency order.
...
needs to be regenerated from `data/finaldata`.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run current finaldata XLK robustness pipeline")
